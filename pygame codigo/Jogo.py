...
# Muda imagem para botar o nome na caixinha
...
# Printando todas as informações na tela, junto com a imagem de fundo (tela inicial, nome, pontuacao)
...
# Cria um grupo só dos carrinhos policiais (animacao das rodas?)
...
# Propabilidade de sortear Estrelinha
        
# Probabilidade de sortear "Mais"(+)
        
# Probabilidade de sortear Oleo
